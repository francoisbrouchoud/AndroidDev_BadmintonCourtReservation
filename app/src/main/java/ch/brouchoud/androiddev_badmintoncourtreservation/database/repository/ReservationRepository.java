...
import ch.brouchoud.androiddev_badmintoncourtreservation.database.async.reservation.CreateReservation;
import ch.brouchoud.androiddev_badmintoncourtreservation.database.async.reservation.DeleteReservation;
import ch.brouchoud.androiddev_badmintoncourtreservation.database.async.reservation.UpdateReservation;
